...
## OS Support
App designed for macOS. Compiling it differently might work on Linux distros (as POSIX libraries are used) but not tested in any way, shape, or form. Also can Swift/SwiftUI even compile on Linux
